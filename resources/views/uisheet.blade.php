        ...
        <div class="main-img">
            <div class="container">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <div class="ms-3">
                        <a class="bg-white btn btn-light d-flex" target="_blank" href="{{ ('admin') }}">
                            <img src="{{asset('/images/brands/23.png')}}" width="24px" height="24px"><span class="mx-2 text-danger fw-bold">STAR US</span> <span>ON GITHUB</span></a>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-2">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-start">
                            ...
                            <li class="nav-item">
                                <a class="btn btn-success" aria-current="page" href="{{ ('admin') }}" target="_blank">
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Offcanvas-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div class="bd-example">
                                    <button class="btn btn-primary me-3 mb-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">Toggle top offcanvas</button>
                                    ...
                                    <button class="btn btn-primary me-3 mb-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Toggle right offcanvas</button>
                                    ...
                                    <button class="btn btn-primary me-3 mb-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">Toggle bottom offcanvas</button>
                                    ...
                                    <button class="btn btn-primary me-3 mb-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasLeft" aria-controls="offcanvasLeft">Toggle left offcanvas</button>
                                    ...
                                    <button class="btn btn-primary me-3 mb-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScroll" aria-controls="offcanvasScroll">Toggle Scroll offcanvas</button>
                            ...
                            <div class="tab-pane bd-heading-1 fade show active" id="content-progress-prv" role="tabpanel" aria-labelledby="typo-output">
                                ...
                                <div class="bd-example">
                                    ...
                                    <div class="progress" style="height:10px">
                                        <div class="progress-bar bg-danger progress-bar-striped" role="progressbar" style="width: 40%; height:10px" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    ...
                                    <div class="progress" style="height:10px">
                                        <div class="progress-bar bg-primary progress-bar-striped" role="progressbar" style="width: 40%; height:10px" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <div class="wrapper-progress mt-4">
                                        <div class="percentage-progress d-flex justify-content-end">
                                            <div><span>40%</span></div>
                                    ...
                                    <div class="progress" style="height:10px">
                                        <div class="progress-bar bg-success progress-bar-striped" role="progressbar" style="width: 40%; height:10px" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
