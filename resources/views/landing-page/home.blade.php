        ...
        <div class="container">
            <div class="row align-items-center text-center text-lg-start">
                <div class="col-lg-6 mt-4 pt-2">
                    ...
                    <a href="#" class="btn btn-primary mt-4">Daftar Pemilih
                        <i data-feather="arrow-right" class="icon-xs icon"></i>
                    </a>
                </div>
                <div class="col-lg-6 mt-lg-4 pt-2 mt-5">
                    <img class="hero-img" src="{{ asset('assets_landing/images/bg.jpg') }} " alt="" style="width: 55vh; margin-left: 18vh;" />
                </div>
            </div>
        </div>
        <!-- end container -->
    ...
    <section class="section bg-light overflow-hidden" id="feature">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="img-container" src="{{ asset('assets_landing/images/chat.png') }}" alt="" />
                </div>
