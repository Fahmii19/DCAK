                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="post" action="{{ route('form-input-pemilih') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select" aria-label="Default select example" name="nama_koordinator" id="nama_koordinator" required>
                                        <option value="" disabled selected>Pilih koordinator</option>
                                        @foreach($koordinator as $k)
                                        <option value="{{ $k->nama_koordinator }}">{{ $k->nama_koordinator }}</option>
                                        @endforeach
                                    </select>
