<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    @if ($userRoles->toArray() && in_array('superadmin', $userRoles->toArray()))
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('total-suara')) }}" aria-current="page"
                href="{{ route('total-suara') }}">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                            d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <span class="item-name">Total Suara</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('koordinator')) || activeRoute(route('input-koordinator')) ? 'active' : '' }}"
                href="{{ route('koordinator') }}">
                <i class="icon">
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('calon-pemilih')) || activeRoute(route('input-calon-pemilih')) ? 'active' : '' }}"
                href="{{ route('calon-pemilih') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('akun-dcak')) || activeRoute(route('input-akun-dcak')) ? 'active' : '' }}"
                href="{{ route('akun-dcak') }}">
    ...
    @if ($userRoles->toArray() && in_array('admin', $userRoles->toArray()))
        ...
        <li class="nav-item" style="display: none;">
            <a class="nav-link {{ activeRoute(route('pemilih')) || activeRoute(route('input-pemilih')) || activeRoute(route('input-pemilih-nama')) ? 'active' : '' }}"
                href="{{ route('pemilih') }}">
    ...
    @if (in_array('superadmin', $userRoles->toArray()) || in_array('admin', $userRoles->toArray()))
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('linjur')) || activeRoute(route('input-linjur')) || activeRoute(route('input-linjur-nama')) ? 'active' : '' }}"
                href="{{ route('linjur') }}">
    ...
    @if ($userRoles->toArray() && in_array('superadmin', $userRoles->toArray()))
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('kelurahan')) || activeRoute(route('input-kelurahan')) ? 'active' : '' }}"
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('kecamatan')) || activeRoute(route('input-kecamatan')) ? 'active' : '' }}"
        ...
        {{-- <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('saksi-tps')) || activeRoute(route('input-saksi-tps')) ? 'active' : '' }}"
                href="{{ route('saksi-tps') }}">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
