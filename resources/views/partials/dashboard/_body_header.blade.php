            ...
            <ul class="navbar-nav ms-auto  navbar-list mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{asset('images/avatars/01.png')}}" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded" style="height: 45px; width: 45px;min-width: 45px;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        {{-- <li><a class="dropdown-item" href="{{route('users.show', auth()->id() || 1)}}">Profil</a>
                </li>
                    ...
                    <form method="POST" action="{{ route('logoutAdmin') }}">
                        ...
                        <a href="javascript:void(0)" class="dropdown-item" onclick="event.preventDefault(); this.closest('form').submit();">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="icon" style="margin-right: 10px; right: 0; position: absolute;">
